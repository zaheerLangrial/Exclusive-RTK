        ...
        <div className="flex space-x-7">
          ...
          <div className="flex items-center space-x-7">
            <div className=" relative">
              <Button 
                child = {HeartIcon} alt = 'Heart Icon' width = {32}
                />
              <p className="bg-[#DB4444] text-xs rounded-full  flex justify-center text-white absolute top-0 right-0 px-1">{likes.length}</p>
            </div>

            <div className=" relative">
              <Link to={'/cart'} >              <Button 
                child = {CartIcon} alt = 'Cart Icon'
                />
                </Link>

              <p className="bg-[#DB4444] text-xs rounded-full  flex justify-center text-white absolute top-0 right-0 px-1">{cartProducts.length}</p>
            </div>
          </div>
        </div>
      </div>
